		...
		<DialogPrimitive.Root open={open} onOpenChange={onOpenChange} defaultOpen={defaultOpen}>
			...
			<DialogPrimitive.Portal>
				...
				<DialogPrimitive.Content className={contentClassName(className)} {...rest}>
					...
					{children}
					<DialogPrimitive.Close className="icon-sm text-muted-foreground hover:bg-error/30 absolute right-0 top-0 size-7 rounded-bl-lg rounded-br-none rounded-tl-none rounded-tr-lg border-b-2 border-l-2">
						<XIcon strokeWidth={3} />
