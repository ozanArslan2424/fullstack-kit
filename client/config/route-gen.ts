...
type ServerRoutePath = "/api/auth/login" | "/api/auth/login" | "/api/auth/logout" | "/api/auth/register" | "/api/auth/register" | "/api/auth/verify-email" | "/api/auth/verify-email" | "/api/auth/verify-email-resend" | "/api/auth/verify-email-resend" | "/api/auth/change-password" | "/api/auth/change-password" | "/api/auth/forgot-password" | "/api/auth/forgot-password" | "/api/auth/profile";
